...
class ClientManager
{
    ...
    private const APP_DESCRIPTION = "NupiCRM – Open Source CRM application.";
    ...
    public function render(?string $runScript = null, ?string $htmlFilePath = null, array $vars = []): string
    {
        ...
        $data = [
            'applicationId' => 'NupiCRM-application-id',
            'apiUrl' => $this->apiUrl,
            'applicationName' => $this->config->get('applicationName', 'NupiCRM'),
