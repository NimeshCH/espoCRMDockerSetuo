...
abstract class Base
{
    ...
    /**
     * Check if version of upgrade/extension is acceptable to current version of NupiCRM.
     *
     * @return bool
     * @throws Error
     */
    protected function isAcceptable()
    {
        ...
        if (isset($manifest['acceptableVersions'])) {
            $res &= $this->checkVersions(
                ...
                'Your NupiCRM version ({version}) is not supported. Required version: {requiredVersion}.'
            );
        }
